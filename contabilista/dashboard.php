...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8 flex justify-between items-center">
        ...
        <div class="flex space-x-3">
            <a href="relatorios.php" class="px-6 py-3 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg shadow hover:shadow-lg transition border border-gray-200 dark:border-gray-700">
                <i class="fas fa-file-invoice mr-2"></i> Relatórios
            </a>
            <?php if ($isSenior): ?>
            <a href="gerar-pdf.php" class="px-6 py-3 bg-red-600 text-white rounded-lg shadow hover:bg-red-700 transition">
                <i class="fas fa-file-pdf mr-2"></i> Gerar PDF Oficial
            </a>
            <?php else: ?>
            <a href="relatorios.php?preliminar=1" class="px-6 py-3 bg-gray-500 text-white rounded-lg shadow hover:bg-gray-600 transition">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border-b-4 border-green-500">
            <p class="text-sm text-gray-500 uppercase font-bold mb-1">Balanço Geral (Receita)</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border-b-4 border-red-500">
            <p class="text-sm text-gray-500 uppercase font-bold mb-1">Multas Arrecadadas</p>
            <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo formatCurrency($multasPagas); ?></p>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border-b-4 border-blue-500">
            <p class="text-sm text-gray-500 uppercase font-bold mb-1">Reservas Concluídas</p>
            <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo $reservasConcluidas; ?></p>
        </div>
    </div>
            ...
            <div class="p-0">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        ?>
                        <tr class="text-sm">
                            <td class="px-6 py-4 text-gray-600 dark:text-gray-400"><?php echo date('d/m/Y', strtotime($row['data_pagamento'])); ?></td>
                            <td class="px-6 py-4 text-gray-900 dark:text-white"><?php echo $row['descricao'] ?: 'Reserva #'.$row['reserva_id']; ?></td>
                            <td class="px-6 py-4 font-bold text-green-600"><?php echo formatCurrency($row['valor']); ?></td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div class="space-y-4">
                <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600">
                    ...
                    <button class="w-full py-2 bg-primary dark:bg-secondary text-white rounded text-sm hover:opacity-90 transition">
                ...
                <div class="p-4 rounded-lg bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900">
                    ...
                    <p class="text-xs text-red-600 dark:text-red-500 mb-4">Existem 3 lançamentos inseridos por estagiários que aguardam sua aprovação.</p>
                ...
                <div class="p-4 rounded-lg bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900">
                    ...
                    <p class="text-xs text-blue-600 dark:text-blue-500">Seus lançamentos serão revisados por um Contabilista Sénior antes de serem oficializados nos relatórios finais.</p>
                </div>
                <?php endif; ?>
            </div>
        </div>
