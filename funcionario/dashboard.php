    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between">
                ...
                <i class="fas fa-building text-4xl text-primary dark:text-secondary"></i>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo $vagasLivres; ?></p>
                </div>
                <i class="fas fa-parking text-4xl text-green-500"></i>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Reservas Ativas</p>
                    <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo $reservasAtivas; ?></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border-l-4 border-red-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Saídas Pendentes</p>
                    <p class="text-3xl font-bold text-red-600 dark:text-red-400"><?php echo $saidasPendentesCount; ?></p>
                </div>
                <i class="fas fa-sign-out-alt text-4xl text-red-500 animate-pulse"></i>
            </div>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-red-200 dark:divide-red-800">
                ...
                <tbody class="divide-y divide-red-100 dark:divide-red-900">
                    ...
                    <tr class="text-sm">
                        <td class="px-6 py-4">
                            <p class="font-bold text-gray-900 dark:text-white"><?php echo e($req['usuario_nome']); ?></p>
                            <p class="text-xs text-gray-600 dark:text-gray-400"><?php echo e($req['marca_veiculo']); ?> (<?php echo e($req['matricula']); ?>)</p>
                        </td>
                        <td class="px-6 py-4">
                            <p class="font-semibold text-gray-900 dark:text-white"><?php echo e($req['numero_vaga']); ?></p>
                            <p class="text-xs text-gray-600 dark:text-gray-400"><?php echo e($req['estacionamento_nome']); ?></p>
                        </td>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100"><?php echo e($reserva['estacionamento_nome']); ?></td>
