        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 transition-colors duration-200">
            ...
            <form method="POST" action="" id="loginForm">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="recover.php" class="text-sm text-primary dark:text-secondary hover:underline">Esqueceu a senha?</a>
                </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Não tem uma conta? 
                    <a href="register.php" class="text-primary dark:text-secondary font-semibold hover:underline">Registre-se aqui</a>
                </p>
            </div>
        </div>
    </div>
