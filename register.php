...
<body class="bg-gradient-to-br from-blue-50 to-green-50 dark:from-gray-900 dark:to-gray-800 min-h-screen flex items-center justify-center py-12 transition-colors duration-200">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 transition-colors duration-200">
            ...
            <form method="POST" action="" id="registerForm">
                ...
                <div class="mb-6 border-t border-gray-200 dark:border-gray-700 pt-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="mb-4">
                            <label for="marca" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Marca</label>
                        ...
                        <div class="mb-4">
                            <label for="modelo" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Modelo</label>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="mb-4">
                            <label for="matricula" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Matrícula</label>
                            <input type="text" id="matricula" name="matricula" required
                                   class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary dark:focus:ring-secondary transition"
                                   placeholder="ABC-123-XY" value="<?php echo e($_POST['matricula'] ?? ''); ?>">
                        </div>
                        <div class="mb-4">
                            <label for="cor" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Cor</label>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Já tem uma conta?
                    <a href="index.php" class="text-primary dark:text-secondary font-semibold hover:underline">
                        Faça login aqui
                    </a>
                </p>
            </div>
