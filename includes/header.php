...
// Count pending vehicle requests for badge (Admin and Funcionario)
$pendingRequestsCount = 0;
if (isLoggedIn() && (hasRole('admin') || hasRole('funcionario'))) {
    $stmtReq = $pdo->query("SELECT COUNT(*) FROM solicitacoes_veiculos WHERE status = 'pendente'");
    $pendingRequestsCount = $stmtReq->fetchColumn();
}
?>
<!DOCTYPE html>
...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-200">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="<?php echo getRoleRedirect($_SESSION['user_role'] ?? 'usuario'); ?>"
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <?php if (isLoggedIn()): ?>
                        <?php if (hasRole('admin')): ?>
                            <a href="/smartpark/admin/dashboard.php"
                                class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                <i class="fas fa-chart-line mr-1"></i> Dashboard
                            </a>
                            <a href="/smartpark/admin/reservas.php"
                                class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                <i class="fas fa-calendar-check mr-1"></i> Reservas
                            </a>
                            <a href="/smartpark/admin/pesquisa-matricula.php"
                                class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                <i class="fas fa-search mr-1"></i> Pesquisar
                            </a>
                            <a href="/smartpark/admin/multas.php"
                                class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                <i class="fas fa-exclamation-triangle mr-1"></i> Multas
                            </a>
                            <a href="/smartpark/admin/usuarios.php"
                                class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                <i class="fas fa-users mr-1"></i> Usuários
                            </a>
                            <a href="/smartpark/admin/veiculos.php"
                                class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition <?php echo $currentPage == 'veiculos.php' ? 'text-primary dark:text-secondary' : ''; ?>">
                                <i class="fas fa-car mr-1"></i> Veículos
                            </a>
                            <a href="/smartpark/admin/pedidos-veiculos.php"
                                class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition <?php echo $currentPage == 'pedidos-veiculos.php' ? 'text-primary dark:text-secondary' : ''; ?>">
                                <i class="fas fa-clipboard-list mr-1"></i> Pedidos
                                <?php if ($pendingRequestsCount > 0): ?>
                                    <span
                                        class="ml-1 px-1.5 py-0.5 text-[10px] font-bold bg-red-600 text-white rounded-full animate-pulse">
                        ...
                        <?php elseif (hasRole('funcionario')): ?>
                            <a href="/smartpark/funcionario/dashboard.php"
                                class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                <i class="fas fa-chart-line mr-1"></i> Dashboard
                            </a>
                            <a href="/smartpark/funcionario/reservas.php"
                                class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                <i class="fas fa-calendar-check mr-1"></i> Reservas
                            </a>
                            <a href="/smartpark/funcionario/pesquisa-matricula.php"
                                class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                <i class="fas fa-search mr-1"></i> Pesquisar
                            </a>
                            <a href="/smartpark/funcionario/multas.php"
                                class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                <i class="fas fa-exclamation-triangle mr-1"></i> Multas
                            </a>
                            <a href="/smartpark/admin/pedidos-veiculos.php"
                        ...
                        <?php elseif (isAccountant()): ?>
                            <a href="/smartpark/contabilista/dashboard.php"
                                class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                <i class="fas fa-calculator mr-1"></i> Dashboard
                            </a>
                            <a href="/smartpark/contabilista/relatorios.php"
                                class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                <i class="fas fa-file-invoice mr-1"></i> Relatórios
                            </a>
                        <?php else: ?>
                            <a href="/smartpark/usuario/dashboard.php"
                                class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                <i class="fas fa-chart-line mr-1"></i> Dashboard
                            </a>
                            ...
                            <a href="/smartpark/usuario/veiculos.php"
                                class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                <i class="fas fa-car mr-1"></i> Meus Veículos
                            </a>
                            <a href="/smartpark/usuario/minhas-multas.php"
                                class="relative px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                    ...
                    <?php if (isLoggedIn()): ?>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open"
                                class="flex items-center space-x-2 px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                            ...
                            <div x-show="open" @click.away="open = false" x-transition
                                ...
                                <a href="/smartpark/logout.php"
                                    class="block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 text-red-600 dark:text-red-400">
            ...
            <div class="px-2 pt-2 pb-3 space-y-1">
                <?php if (isLoggedIn()): ?>
                    <?php if (hasRole('admin')): ?>
                        ...
                        <a href="/smartpark/admin/pedidos-veiculos.php"
                            class="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-100 dark:hover:bg-gray-700 flex justify-between items-center">
                            <span><i class="fas fa-clipboard-list mr-2"></i> Pedidos</span>
                            <?php if ($pendingRequestsCount > 0): ?>
                                <span class="px-2 py-0.5 text-xs font-bold bg-red-600 text-white rounded-full">
                                    <?php echo $pendingRequestsCount; ?>
                                </span>
                            <?php endif; ?>
                        </a>
                    ...
                    <?php else: ?>
                        ...
                        <a href="/smartpark/usuario/minhas-multas.php"
                            class="relative block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <a href="/smartpark/logout.php"
                        class="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-100 dark:hover:bg-gray-700 text-red-600 dark:text-red-400">
                        <i class="fas fa-sign-out-alt mr-2"></i> Sair
                    </a>
                <?php endif; ?>
            </div>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="font-semibold">
                                    Você possui <?php echo $resumoMultas['quantidade']; ?>
                                    multa<?php echo $resumoMultas['quantidade'] > 1 ? 's' : ''; ?>
                                    pendente<?php echo $resumoMultas['quantidade'] > 1 ? 's' : ''; ?>
                                </p>
    ...
    if ($flash):
        ...
        <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)" x-transition
            ...
            <div
                class="<?php echo $flash['type'] === 'success' ? 'bg-green-100 border-green-500 text-green-900' : 'bg-red-100 border-red-500 text-red-900'; ?> border-l-4 p-4 rounded shadow-lg">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <i
                            class="fas <?php echo $flash['type'] === 'success' ? 'fa-check-circle' : 'fa-exclamation-circle'; ?> mr-2"></i>
